  ...
  <form id="search-form" class="search-form">
    ...
    <div class="search-form__group search-form__group--select">
      <div class="search-form__select-wrapper">
        ...
        <span class="search-form__select-icon"><i class="fas fa-chevron-down"></i></span>
      </div>
    </div>
    ...
    <div class="search-form__group search-form__group--input">
      <div class="search-form__input-wrapper">
        ...
        <input type="text" name="keyword" id="keyword"
          ...
          placeholder="Search..." class="search-form__input">
      </div>
    </div>

    <!-- リセットボタン -->
    <div class="search-form__group search-form__group--reset">
      <button type="button" id="reset-button" class="search-form__reset-button">リセット</button>
    </div>
  </form>
</div>